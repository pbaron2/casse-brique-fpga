...
# Generated on: Tue Oct 23 14:27:53 2018
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "test_depl_plateforme"]} {
...
if {$make_assignments} {
	...
	set_global_assignment -name VERILOG_FILE output_files/3.v
	set_global_assignment -name QIP_FILE Nios_balle/synthesis/Niosballe.qip
	set_global_assignment -name VERILOG_FILE hdmi/1.v

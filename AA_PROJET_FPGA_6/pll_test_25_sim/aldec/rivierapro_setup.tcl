...
# ACDS 18.0 614 win32 2018.10.25.12:41:32
# ----------------------------------------
...
# ----------------------------------------
# If pll_test_25 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_test_25"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_test_25.vho"
}
